...
// HTTP behaviour is covered in pragmaticengineer_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "pragmaticengineer://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("pragmaticengineer", "about")
	if err != nil || got.String() != "pragmaticengineer://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want pragmaticengineer://page/about", got.String(), err)
	}
}
