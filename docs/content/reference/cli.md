...
```
pragmaticengineer <command> [arguments] [flags]
```

Run `pragmaticengineer <command> --help` for the full flag list on any command. This
...
per operation you declare in `pragmaticengineer/domain.go`.
